...
<template>
    <section class="relative min-h-screen bg-linear-to-br from-gray-900 via-black to-gray-900 text-white py-20 px-6 md:px-12 overflow-hidden">
        ...
        <div class="relative z-10 max-w-7xl mx-auto">
            ...
            <!-- Loading State -->
            <div v-if="loading" class="flex justify-center items-center min-h-screen bg-linear-to-br from-gray-900 via-black to-gray-800">
                <div class="relative">
                    ...
                    <div class="flex flex-wrap items-center gap-4 pt-6 justify-between">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <a
                                ...
                                class="flex items-center gap-2 p-3 bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 hover:border-gray-600 rounded-lg transition-all duration-300"
                                aria-label="View on GitHub"
                            >
                                <svg class="w-6 h-6 text-gray-300 transition-colors" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <span class="text-gray-300 font-medium group-hover:text-white text-sm">GitHub</span>
                            </a>
                            ...
                            >
                                <svg class="w-6 h-6 text-gray-300 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                                </svg>
                                <span class="text-gray-300 font-medium group-hover:text-white text-sm">Live Demo</span>
                            </a>
                        </div>
